...
-- Loop en tiempo real + auto-guardado cada 10s
local SaveCounter = 0
task.spawn(function()
...
WindUI:Notify({Title="DENJI•ALEX", Content="v10: Game con Funciones Universales", Duration=4})
